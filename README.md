...
Conteúdo: **832 tabelas**, **1097 vistas**, **932 validações** (1GAT+1GCO+1GEP), **90 classes** de API, modelo de objetos do SDK, **5 referências funcionais** por módulo, **2 specs de integração** (EDI/UBL) e histórico de versões.
